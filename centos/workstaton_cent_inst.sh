...
#installing software
yum -y install epel-release && yum repolist && yum -y install yumex xrdp htop iftop tmux mc sl ; yum -y install google-chrome-stable webmin ; yum -y install cockpit cockpit-storaged ; yum groupinstall "KDE Plasma Workspaces" -y ; yum -y install pidgin thunderbird
#add firewall rules
