...
#installing software
yum -y install epel-release && yum repolist && yum -y install yumex xrdp htop iftop tmux ; yum -y install google-chrome-stable webmin ; yum -y install cockpit cockpit-storaged
#add firewall rules
